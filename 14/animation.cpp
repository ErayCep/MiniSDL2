    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    std::cout << "SDL_IMG could not initialized" << std::endl;
                    success = false;
                }
            }
        }
...
bool loadMedia()
{
    ...
    if (!gSpriteSheetTextures.loadFromFile("./foo.png"))
    {
    ...
    else
    {
        ...
        else
        {
            ...
            while (!quit)
            {
                ...
                gSpriteSheetTextures.render((SCREEN_WIDTH - currentClip->w) / 2, (SCREEN_HEIGHT - currentClip->h) / 2, currentClip);
